      ...
      <header style={{background:T.stone,borderBottom:`1px solid ${T.line}`,position:"sticky",top:0,zIndex:100}}>
        <div style={{maxWidth:"960px",margin:"0 auto",padding:"0 40px"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"20px 0 16px",borderBottom:`1px solid ${T.line}`}}>
            <div>
              <h1 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:"24px",fontWeight:400,color:T.ink,letterSpacing:"-0.3px"}}>Pomp Op Sahat</h1>
    ...
    <div className="fade-up">
      ...
      <div style={{marginBottom:"64px"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"baseline",marginBottom:"12px"}}>
          ...
          <p style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:"24px",color:T.ink}}>{collection}%</p>
        </div>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr auto",gap:"24px",alignItems:"start"}}>
                  <div>
                    <div style={{display:"flex",alignItems:"center",gap:"16px",marginBottom:"6px",flexWrap:"wrap"}}>
                      <h3 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:"22px",fontWeight:400,color:T.ink}}>{hh.lead}</h3>
      ...
      <div style={{borderTop:`1px solid ${T.line}`,paddingTop:"32px"}}>
        ...
        {isCoord&&<p style={{marginTop:"24px",fontSize:"13px"}}><a href="https://docs.google.com/spreadsheets/d/19vHRDue6attrpewZcFNBSq3g3UvxbalaWCog6v5x0d4/edit?usp=sharing" target="_blank" rel="noopener noreferrer" style={{color:T.forest,textDecoration:"none",borderBottom:`1px solid ${T.forest}`}}>Buka Google Sheets Lusiana ↗</a></p>}
      </div>
    </div>
  );
});
  ...
  return (
    <div className="fade-up">
      <div style={{marginBottom:"56px"}}>
        ...
        <h2 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:"36px",fontWeight:400,color:T.ink}}>Itinerary v18</h2>
  ...
  return (
    <div className="fade-up">
      <div style={{marginBottom:"56px"}}>
        ...
        <h2 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:"36px",fontWeight:400,color:T.ink}}>Pre-Order F&B</h2>
            ...
            <div key={r.id} onClick={()=>{setActiveResto(r);setView("restaurant");}}
              ...
              <div>
                <div style={{display:"flex",alignItems:"center",gap:"16px",marginBottom:"6px"}}>
                  <h3 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:"22px",fontWeight:400,color:T.ink}}>{r.name}</h3>
        ...
        <div style={{borderTop:`1px solid ${T.line}`}}>
          {UPCOMING_FB.map(r=>(
            <div key={r.name} style={{display:"grid",gridTemplateColumns:"1fr auto",alignItems:"center",gap:"24px",borderBottom:`1px solid ${T.line}`,padding:"24px 0"}}>
              <div>
                <h4 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:"19px",fontWeight:400,color:T.muted,marginBottom:"4px"}}>{r.name}</h4>
    ...
    <div className="fade-up">
      ...
      {tab==="order"&&<div>
        ...
        {submitted&&<div style={{display:"flex",justifyContent:"space-between",alignItems:"center",background:T.settledBg,padding:"14px 20px",marginBottom:"24px"}}>
          <p style={{fontSize:"13px",color:T.settled}}>✓ Order Anda sudah terkirim ke Firebase.</p>
          {!locked&&<button onClick={()=>{setSubmitted(false);setTab("order");}} style={{background:"none",border:`1px solid ${T.settled}`,padding:"5px 14px",cursor:"pointer",fontSize:"12px",letterSpacing:"1.5px",textTransform:"uppercase",color:T.settled}}>Edit</button>}
        </div>}
            ...
            {c.items.map(item=>{
              ...
              return (
                <div key={item.id} style={{display:"grid",gridTemplateColumns:"1fr auto",gap:"24px",alignItems:"center",borderBottom:`1px solid ${T.line}`,padding:"20px",margin:"0 -20px",background:isDisabled?T.stone:inCart?T.cream:"transparent",opacity:isDisabled?0.45:1,transition:"background 0.2s"}}>
                  <div>
                    <p style={{fontSize:"16px",color:isDisabled?T.muted:T.ink,fontWeight:inCart?500:300,marginBottom:"2px"}}>{item.name}</p>
        ...
        {cartCount>0&&<div style={{marginTop:"40px",padding:"32px",background:T.cream,borderTop:`2px solid ${T.forest}`}}>
          ...
          {Object.entries(cart).map(([id,item])=>(
            <div key={id} style={{display:"flex",justifyContent:"space-between",padding:"8px 0",borderBottom:`1px solid ${T.line}`}}>
              ...
              <span style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:"18px",color:T.ink}}>×{item.qty}</span>
            </div>
          ))}
              ...
              return <div style={{borderTop:`1px solid ${T.line}`}}>
                {sorted.map(([name,qty])=>(
                  <div key={name} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"14px 0",borderBottom:`1px solid ${T.line}`}}>
                    ...
                    <span style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:"22px",color:T.forest}}>{qty}×</span>
                  </div>
                ))}
              </div>;
            })()}
                  ...
                  <div key={p.name} style={{display:"grid",gridTemplateColumns:"1fr auto",gap:"16px",alignItems:"start",borderBottom:`1px solid ${T.line}`,padding:"16px 0",background:isMe?T.cream:"transparent"}}>
                    <div>
                      ...
                      {o&&<div style={{display:"flex",flexWrap:"wrap",gap:"8px"}}>
                        {(o.items||[]).map((it,i)=><span key={i} style={{fontSize:"12px",color:T.muted}}>• {it.name} ×{it.qty}{it.notes&&` (${it.notes})`}</span>)}
                      </div>}
                    </div>
